...
const pageTitle = computed(() => {
  ...
  if (path === '/teacher') return 'Dashboard Pengajar'
  if (path.includes('/teacher/classes')) return 'Kelas Mengajar'
  if (path.includes('/teacher/profile')) return 'Profil Pengajar'
  return 'Portal Guru'
})
      ...
      <header class="h-16 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 sticky top-0 z-20 flex items-center justify-between px-4 sm:px-6">
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center gap-2">
            <span class="text-xs font-medium text-gray-400 hidden sm:inline-block">Guru /</span>
          ...
          >
            ...
            >
              <UAvatar
                ...
                size="sm"
                class="cursor-pointer ring-2 ring-emerald-500/20"
              />
            </UDropdownMenu>
          </div>
        </div>
